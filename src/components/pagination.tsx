...
export default function Pagination(){
    ...
    return (
        <div className="flex gap-2 pb-5 justify-end">
            <Button onClick={handleStartPages}  size={"icon"} variant={"secondary"}><ArrowLeftToLine /></Button>
            <Button onClick={handleMinusPages} size={"icon"} variant={"secondary"}><ArrowLeft /></Button>
            ...
            <Button onClick={handlePlusPages} size={"icon"} variant={"secondary"}><ArrowRight /></Button>
            <Button onClick={handleFinalPages} size={"icon"} variant={"secondary"}><ArrowRightToLine /></Button>
        </div>
    )
}